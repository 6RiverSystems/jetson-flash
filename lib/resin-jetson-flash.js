...
module.exports = class ResinJetsonFlash {
	constructor(deviceType, image, assetDir, output) {
		...
		this.dictionary = {
			['jetson-tx2']: {
				url:
					process.env.L4T_PACKAGE || 'https://developer.nvidia.com/embedded/L4T/r32_Release_v4.4/r32_Release_v4.4-GMC3/T186/Tegra186_Linux_R32.4.4_aarch64.tbz2',
				partitions: {
	...
	spawnFlash() {
		return new Bluebird(async (resolve, reject) => {
			...
			const odmdata = process.env.ODMDATA;
